...
export interface TraceRecord {
  ...
  /** Which correlation strategy resolved this trace, when the backend can tell. */
  readonly resolvedVia?: "traceparent" | "session";
}
...
export interface TraceLookupContext {
  ...
  /** Trace id generated by the runner for this attempt, when `traceparent` was sent. */
  readonly traceId?: string;
}
